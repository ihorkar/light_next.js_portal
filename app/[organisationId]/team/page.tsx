...
export default function Page({ params }: {
  ...
  const handleOnSendInvitation = () => {
    ...
    API.sendInvitation(params.organisationId, userData)
      ...
      .catch(error => console.log("Error while sending the invitation", error))
  }
  ...
  return (
    ...
    <Modal 
      ...
      onCancelClick={() => setShowInvitationModal(false)} 
      onOkClick={!isSentInvitation ? handleOnSendInvitation : () => setShowInvitationModal(false)}
    >      
      {!isSentInvitation ? 
      <form ref={formEl}>
