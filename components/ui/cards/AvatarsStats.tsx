const user = {
    name: 'John Doe',
    role: 'Fundraiser extraordinaire',
    imageUrl:
      '/johndoeavatar.png?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80',
  }
  const stats = [
    { label: 'projects worked', value: 2 },
    { label: 'days active', value: 12 },
    { label: 'signups made', value: 25 },
  ]
